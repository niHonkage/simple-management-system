export default {
  login: {
    title: 'User Login',
    loginBtn: 'Login',
    usernameRule1: 'Username is required',
    usernameRule2: 'The username is 4 to 15 characters long',
    passwordRule2: 'Password cannot be less than 6 digits',
    passwordRule1: 'Please enter password',
    isCheckOut: 'Please check if the form information is correct',
    desc: `
