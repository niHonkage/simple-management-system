<template>
  <div class="user-info-container">
    <el-card class="print-box">
      <el-button type="primary" :loading="loading" v-print="printObj">{{ $t('msg.userInfo.print') }}</el-button>
    </el-card>
    <el-card>
      <div class="user-info-box" id="userInfoBox" v-print="printObj">
        <!-- 标题 -->
        ...
        <div class="header">
          ...
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item :label="$t('msg.userInfo.date')">{{
              $filters.dayFilter(detailData.openTime)
            }}</el-descriptions-item>
            ...
            <el-descriptions-item :label="$t('msg.userInfo.experience')">
              <ul>
                <li v-for="(item, index) in detailData.experience" :key="index">
                  <span>
                    {{ $filters.dayFilter(item.startTime, 'YYYY/MM') }}
                    ----
                    {{ $filters.dayFilter(item.endTime, 'YYYY/MM') }}</span
                  >
